...
if(isset($_POST['submit'])){
    ...
    elseif($_POST['usertype'] == "Staff"){
        ...
        if($query->num_rows != 0){
            ...
            $_SESSION['perm1'] = $row['perm1'];
            $_SESSION['perm2'] = $row['perm2'];
            $_SESSION['perm3'] = $row['perm3'];
            $session = md5($_SERVER['HTTP_USER_AGENT']);
            $conn->query("INSERT INTO `tbl_sessions` VALUES (NULL, '".$_SESSION['username']."', '".$_SESSION['usertype']."', '$session')");
        ...
        die("<script>alert('Invalid Usertype!');window.location = 'index.php';</script>");
        exit();
    }
}
?>
            ...
            <div class="card-body">
              <div class="p-5">
                <div class="text-center">
                  ...
                  <br>
                  <br>
                  <h4 class="text-dark mb-4">Administrator / Staff</h4>
                </div>
                ...
                <div class="mb-3 user d-flex justify-content-center">
                    Forgot your password?&nbsp;<a href="forgot.php" style="text-decoration:none;">Click here.</a>
                </div>
                <div class="mb-3 user d-flex justify-content-center">
                    Not an admin/staff?&nbsp;<a href="student_login.php" style="text-decoration:none;">Login here.</a>
                </div>
              </div>
            </div>
          </div>
